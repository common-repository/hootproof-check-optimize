	...
	class TGM_Plugin_Activation {
		...
		public function install_plugins_page() {
			...
			<div class="tgmpa wrap">
                ...
                <h3><?php echo esc_html__( 'A quick note on recommended plugins', 'hootproof-check'); ?></h3>
                <p><strong><?php echo esc_html__( 'These plugin recommendations are a guideline. If you already have similiar plugins installed, simply ignore the suggestions or switch plugins. Do not install multiple plugins for the same features!', 'hootproof-check'); ?></strong></p>
		...
		public function notices() {
			...
			//added mretzlaff
			//only show these notices on the HootProof plugin dashboard
			//new: never show notices
			//if ( !$this->is_hootproof_dashboard_page()) return;
			return;
		...
		/**
		 * Determine if we're on the HootProof Dashboard page.
		 *
		 * @since 2.1.0
		 *
		 * @return boolean True when on the HootProof dashboard page, false otherwise.
		 */
		protected function is_hootproof_dashboard_page() {
			return isset( $_GET['page'] ) && 'hootproof_menu' === $_GET['page'];
		}
