jQuery(function ($) {
  ...
  $('#gfw-parameters').submit(function(event) {
    ...
    $('#gfw-screenshot').css('background-image','url(../wp-content/plugins/hootproof-check-optimize/images/loading-screenshot.png)');
    ...
    $.ajax({
      ...
      success: function(data) {
        if (data.error) {
          $('#gfw-scanner').hide();
          $('#gfw-screenshot').css('background-image','url(../wp-content/plugins/hootproof-check-optimize/images/exclamation.png)');
